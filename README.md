...
|---|---|---:|---|---|---|
| [dsh-llm-codex](https://github.com/NOirBRight/dsh-llm-codex) | Plugin | [v0.3.9](https://github.com/NOirBRight/dsh-llm-codex/tree/v0.3.9) | Active | ChatGPT Codex subscription login, sortable model catalog, Fast and 1M variants, live usage limits, and optional search and image tools. | Credentials, Network, OAuth, Third-party service, Subscription |
| [dsh-llm-commandcode](https://github.com/NOirBRight/dsh-llm-commandcode) | Plugin | [v0.1.19](https://github.com/NOirBRight/dsh-llm-commandcode/tree/v0.1.19) | Active | Command Code Provider API chat with Host-only model discovery, credential storage, and best-effort subscription usage reporting. | Credentials, Network, Third-party service, Subscription, Unofficial API |
| [dsh-llm-cursor](https://github.com/NOirBRight/dsh-llm-cursor) | Plugin | [v0.2.16](https://github.com/NOirBRight/dsh-llm-cursor/tree/v0.2.16) | Active | Unofficial Cursor subscription login and chat with Host-owned PKCE credentials, model discovery, and subscription usage rails. | Account-ban risk, Credentials, Network, OAuth, Third-party service, Subscription, Unofficial API |
| [dsh-llm-grok](https://github.com/NOirBRight/dsh-llm-grok) | Plugin | [v0.3.9](https://github.com/NOirBRight/dsh-llm-grok/tree/v0.3.9) | Active | xAI Grok subscription login and Responses chat with configurable models, usage reporting, server-side search, and Imagine generation. | Credentials, Network, OAuth, Third-party service, Subscription |
| [dsh-llm-ollama](https://github.com/NOirBRight/dsh-llm-ollama) | Plugin | [v0.6.17](https://github.com/NOirBRight/dsh-llm-ollama/tree/v0.6.17) | Active | Ollama Cloud chat through the OpenAI-compatible adapter, plus native model discovery and Web Search and Fetch providers. | Credentials, Network, Third-party service |
| [dsh-llm-opencode-go](https://github.com/NOirBRight/dsh-llm-opencode-go) | Plugin | [v0.1.19](https://github.com/NOirBRight/dsh-llm-opencode-go/tree/v0.1.19) | Active | OpenCode Go models with per-model Completions, Responses, or Anthropic Messages routing, discovery, and subscription usage. | Credentials, Network, Third-party service, Subscription |
...
| [dsh-llm-providers-ui](https://github.com/NOirBRight/dsh-llm-providers-ui) | Plugin | [v0.1.5](https://github.com/NOirBRight/dsh-llm-providers-ui/tree/v0.1.5) | Active | Shared LLM Providers settings owner for provider cards, navigation, and persisted ordering across independent model plugins. | UI extension |
| [dsh-model-switch](https://github.com/NOirBRight/dsh-model-switch) | Plugin | [v0.4.6](https://github.com/NOirBRight/dsh-model-switch/tree/v0.4.6) | Active | Explicit routing for Main, Subagent, Composer, Plan Review, Web Search, and image generation without patching DSH Core. | UI extension |
...
| [dsh-external-agents](https://github.com/NOirBRight/dsh-external-agents) | Plugin | [v0.2.3](https://github.com/NOirBRight/dsh-external-agents/tree/v0.2.3) | Active | External Agent control plane for Codex, Claude Code, Cursor Agent, and Antigravity adapters with settings and background job visibility. | Credentials, Network, Subprocess, UI extension |
...
| [dsh-ponytail](https://github.com/NOirBRight/dsh-ponytail) | Plugin | [v0.2.3](https://github.com/NOirBRight/dsh-ponytail/tree/v0.2.3) | Active | Ponytail session modes and review skills with persisted mode controls, Native Subagent inheritance, and compact runtime prompts. | Session data, UI extension |
...
| [dsh-mobile-pairing](https://github.com/NOirBRight/dsh-mobile-pairing) | Plugin | [v0.1.15](https://github.com/NOirBRight/dsh-mobile-pairing/tree/v0.1.15) | Active | DSH Mobile Host pairing with a loopback gateway, public endpoint discovery, WebRTC Direct, and encrypted tunnel fallback. | Credentials, Network, Remote access |

### Usage & Observability

| Entry | Type | Version | Status | Description | Disclosures |
|---|---|---:|---|---|---|
| [dsh-usage-monitor](https://github.com/NOirBRight/dsh-usage-monitor) | Plugin | [v0.2.11](https://github.com/NOirBRight/dsh-usage-monitor/tree/v0.2.11) | Active | Session-log usage dashboard for tokens, requests, output, and cache-hit rates, grouped by provider, model, or workspace. | Session data, UI extension |
